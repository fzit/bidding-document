...
- php-ci-cms：基于 CodeIgniter 开发的一套轻量级 PHP 框架，包含企业网站的通用模块，适用于小型企业网站和轻量级 API 服务；[链接](https://git.oschina.net/zhaojintian/cms)（出于安全考虑，不开源）
- 团队成员曾参与 Linux 服务器集群管理面板 - AppNode 的开发（AppNode 前身 VPSMate 获阿里云开发者大赛一等奖）；[链接](https://www.appnode.com/)
